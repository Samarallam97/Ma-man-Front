...
function CategoryFilter({ onSearch, itemsPerPage, onItemsPerPageChange }) {
  ...
  return (
    <div className="w-full md:w-auto flex flex-col sm:flex-row gap-2">
      ...
      >
        <option value="4">4 {t('categories.perPage')}</option>
        <option value="8">8 {t('categories.perPage')}</option>
        <option value="12">12 {t('categories.perPage')}</option>
        <option value="16">16 {t('categories.perPage')}</option>
      </select>
    </div>
  )
}
